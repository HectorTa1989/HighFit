...
class PlanStepTwoFragment : Fragment(), MemoryManagement {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Set up touch listener to dismiss keyboard when touching outside input fields
    ...
    private fun setupKeyboardDismissal(view: View) {
        // Set up touch listener on root view to dismiss keyboard
        view.setOnTouchListener { v, event ->
            if (event.action == android.view.MotionEvent.ACTION_DOWN) {
                // Check if touch is outside any input field
